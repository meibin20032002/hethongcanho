...
*/
function BdsCkBuildRoute(&$query)
{
	$view = null;
	$segments = array();
	if(isset($query['view']))
...
*/
function BdsCkParseRoute($segments)
{
	$vars = array();
	$view = null;
...
*/
function BdsCkParseSlug($slug, $model, $aliasKey)
{
	$parts = explode( ':', $slug );
	$id = $parts[0];
...
*/
function BdsCkBuildSlug($id, $model, $aliasKey)
{
	$item = BdsHelper::getData($model, array(
