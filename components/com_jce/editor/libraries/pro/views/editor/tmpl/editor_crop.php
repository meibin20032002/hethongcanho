...
<h3 id="transform-crop" data-action="crop">
    <a href="#">
<?php echo WFText::_('WF_MANAGER_TRANSFORM_CROP', 'Crop'); ?>
    </a>
</h3>
<div class="uk-form">
	<div class="uk-grid uk-grid-small">
			...
			<input type="text" id="crop_width" value="" class="uk-width-2-10" />

      <label for="crop_x" class="uk-width-3-10 uk-text-center">
        <?php echo WFText::_('WF_LABEL_CROP_X', 'X'); ?>
      </label>
      <input type="text" id="crop_x" value="" class="uk-width-2-10" />
</div>
...
<div class="uk-grid uk-grid-small">
  ...
  <input type="text" id="crop_height" class="uk-width-2-10" />

    <label for="crop_y" class="uk-width-3-10 uk-text-center">
      <?php echo WFText::_('WF_LABEL_CROP_Y', 'Y'); ?>
    </label>
    <input type="text" id="crop_y" class="uk-width-2-10" />
</div>
    ...
    <div class="uk-width-4-10">
      <input type="checkbox" id="crop_constrain" />
        ...
        <option value=""><?php echo WFText::_('WF_MANAGER_TRANSFORM_PRESET_ORIGINAL'); ?></option>
	...
	<div class="uk-form-row uk-align-right uk-margin-top uk-margin-bottom">
		<a role="button" id="crop_apply" class="uk-button apply" data-function="crop">
			<?php echo WFText::_('WF_LABEL_APPLY'); ?>
		</a>
		<a role="button" id="crop_reset" class="uk-button reset" data-function="crop">
