...
<div class="uk-grid uk-grid-small">
    <div class="uk-width-4-5 uk-width-mini-1-1">
        <div class="uk-grid uk-grid-small">
            <label class="uk-form-label uk-width-1-5" for="src" class="hastip" title="<?php echo WFText::_('WF_LABEL_URL_DESC'); ?>"><?php echo WFText::_('WF_LABEL_URL'); ?></label>
        ...
        <div class="uk-grid uk-grid-small">
            ...
            <div class="uk-width-2-5 html4">
                <label for="frameborder" class="hastip uk-form-label uk-width-3-5" title="<?php echo JText::_('WF_IFRAME_FRAMEBORDER_DESC'); ?>"><?php echo WFText::_('WF_IFRAME_FRAMEBORDER'); ?></label>
        ...
        <div class="uk-grid uk-grid-small html4">
            <label for="scrolling" class="hastip uk-form-label uk-width-1-5" title="<?php echo WFText::_('WF_IFRAME_SCROLLING_DESC'); ?>">
              <?php echo WFText::_('WF_IFRAME_SCROLLING'); ?>
          </label>
