	...
	<table class='table' id='grid-categories'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("BDS_FIELD_SUB_CATEGORY"); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			<tr class="<?php echo "row$k"; ?>" sortable-group-id="<?php echo $row->sub_category; ?>">
				<?php if ($model->canSelect()): ?>
				<td>
				...
				<td style="text-align:center">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => 'title',
						'dataObject' => $row,
						'route' => array('view' => 'category','layout' => 'category','cid[]' => $row->id)
					));?>
				</td>

				<td style="text-align:center">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => '_sub_category_title',
						'dataObject' => $row
					));?>
				</td>
