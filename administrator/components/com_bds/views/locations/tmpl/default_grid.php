...
<div class="">
	<table class='table' id='grid-locations'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("BDS_FIELD_SUB_LOCATION"); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			<tr class="<?php echo "row$k"; ?>" sortable-group-id="<?php echo $row->sub_location; ?>">
				<?php if ($model->canSelect()): ?>
				<td>
				...
				<td style="text-align:center">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => 'title',
						'dataObject' => $row,
						'route' => array('view' => 'location','layout' => 'location','cid[]' => $row->id)
					));?>
				</td>
