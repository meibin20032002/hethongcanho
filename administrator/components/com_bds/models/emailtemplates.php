...
* @subpackage	Classes
*/
class BdsModelEmailtemplates extends BdsClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'emailtemplate';
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		// SEARCH : Slug Name + Subject + Avail Attribute
		$this->orm->search('search', array(
			'on' => array(
				'slug_name' => 'like',
				'subject' => 'like',
				'avail_attribute' => 'like'
			)
		));

		// ORDERING
		$orderCol = $this->getState('list.ordering', 'slug_name');
