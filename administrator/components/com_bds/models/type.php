...
* @subpackage	Classes
*/
class BdsModelType extends BdsClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'type', 'STRING');
	}
	...
	*/
	public function getTable($type = 'type', $prefix = 'BdsTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_bds.edit.type.data', array());
	...
	* @param	integer	$pk	The primary id key of the type
	*
	* @return	void
	*/
