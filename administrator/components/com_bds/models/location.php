...
* @subpackage	Classes
*/
class BdsModelLocation extends BdsClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'location', 'STRING');
	}
	...
	*/
	...
	{
		$conditions = array('`sub_location` = '.(int) $table->sub_location);
		return $conditions;
	}
	...
	*/
	public function getTable($type = 'location', $prefix = 'BdsTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_bds.edit.location.data', array());
	...
	* @param	integer	$pk	The primary id key of the location
	*
	* @return	void
	*/
