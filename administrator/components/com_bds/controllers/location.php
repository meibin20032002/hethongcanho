...
/**
* Bds Location Controller
*
* @package	Bds
* @subpackage	Location
*/
class BdsControllerLocation extends BdsClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'location', 'CMD');
	}
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'location.apply':
				$this->applyRedirection($result, array(
					...
					'cid[]' => $model->getState('location.id')
				));
				break;

			case 'location.save2copy':
				$this->applyRedirection($result, array(
					'stay',
					'com_bds.location.location'
				), array(
